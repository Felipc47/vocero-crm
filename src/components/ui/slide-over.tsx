  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed bottom-0 right-0 top-0 z-40 flex w-[440px] max-w-[92vw] animate-[slide-in-right_.26s_cubic-bezier(.2,.8,.2,1)] flex-col border-l bg-surface shadow-[-16px_0_44px_rgba(0,0,0,.22)]"
      >
        {children}
      </div>
    </>
