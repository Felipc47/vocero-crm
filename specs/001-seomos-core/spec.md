# Feature Specification: Seomos CRM — Núcleo v1 (001-seomos-core)

**Feature Branch**: `001-seomos-core`

**Created**: 2026-07-09

**Status**: Draft

**Input**: Seomos CRM: CRM de WhatsApp con agente de IA, open source (MIT), self-hosted y
...
conversión; sin él, Seomos es solo una bandeja.
...
Como agencia, instalo Seomos en el VPS de mi cliente en ~15 minutos siguiendo el README:
